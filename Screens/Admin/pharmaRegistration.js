...
// create a component
const PharmaRegistration = ({ navigation }) => {
    ...
    useFocusEffect(
        useCallback(
            () => {
                ...
                axios
                    .get(`${baseUrl}registrationRequest`)
                    .then((res) => {
                        ...
                        <FlatList
                            ...
                            renderItem={({ item, index }) => (
                                ...
                                <View style={{
                                    ...
                                    <TouchableOpacity onPress={() => navigation.navigate("PharmaRegistration", { item: item })}>
                                    ...
                                    <View style={{ justifyContent: "space-between", flexDirection: "row" }}>
                                        ...
                                        {item.pharmaApprove !== "" ? (
                                            item.pharmaApprove !=="Rejected"?(<Icon
                                                raised
                                                name='check'
                                                type='font-awesome'
                                                color={Color.primary}
                                          ...
                                          :
                                            ...
                                            <Text style={{color: "#F0D500"}}>...Pending</Text>
